...
unit ReconcilieError;

interface

uses
  SysUtils, Windows, Variants, Messages, Classes, Graphics, Controls, Forms,
  Dialogs, StdCtrls, Grids, DB, DBClient, Provider, ExtCtrls, Buttons;

const
  ActionStr: array[TReconcileAction] of string = ('Pular', 'Cancelar', 'Mesclar',
    'Corrigir', 'Canceler', 'Atualizar');
